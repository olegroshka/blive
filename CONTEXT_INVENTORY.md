...
| 0. Index | **this file** (`CONTEXT_INVENTORY.md`) | DRAFT v0.19 (2026-06-05) | continuous | the registry of all artifacts |
...
18. **M3.3 — OQ-031 resolution.** Operator-led deployment-mode decision over the 4 OQ-031 options on the M3.2 evidence; agent drafts the resolution ADR (next free index after ADR-051), flips OQ-031 OPEN → RESOLVED-BY-ADR-NNN. Kickoff at [NEXT_PROMPT v1.3](./NEXT_PROMPT.md). **Front of the queue.**
