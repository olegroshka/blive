...
| **INV-14** | [`docs/inv/ib_error_codes.md`](./docs/inv/ib_error_codes.md) | DRAFT v0.1 (2026-05-01) | IB error codes blive's adapter handles (typed-exception map + operator action). M2-IB.3b-ii close: 162 (no SBF historical permissions) + 200 (security definition not found) observed and catalogued. Forward-list of KB-3 §8 codes (100/201/202/322/354/366/1100..1102/1300) catalogued for M2-IB.4 / M5 promotion as observed. | DESIGN |
